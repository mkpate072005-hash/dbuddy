...
import { Database, Mail, Lock, Eye, EyeOff, Github, User } from 'lucide-react';
    ...
    <div className="min-h-screen bg-[#080810] flex items-center justify-center px-6 py-12">
      ...
      >
        <div className="text-center mb-8">
          ...
          <h1 className="text-2xl font-bold text-white" style={{ fontFamily: 'Space Grotesk, sans-serif' }}>Create your account</h1>
          <p className="text-gray-500 text-sm mt-1">Start building databases with AI</p>
        </div>
